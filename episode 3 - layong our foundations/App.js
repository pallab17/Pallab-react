...
// creating a react element uisng core react
...
//     id: "heading",
//   },
//   "pb7 loves akshay saini r teaching style"
// );
// // eibar kotha ta hooche je eibhabe toh aar code lekha cholena not a good way to write code
// // so we need jsx to make our life easy

// console.log(heading);
// const baba = ReactDOM.createRoot(document.getElementById("root"));
// // baba will act like the root of react and baba === root for now

// baba.render(heading);

// react element using jsx
const jsxHeading = <h1 id="heading">Namaste react using jsx by pb7</h1>;

console.log(jsxHeading);
//baba.render(jsxHeading);
...
const HeadingComponent = () => (
  <div id="container">
    <h1 id="heading"> functional component pb7</h1>
  </div>
);
const HeadingComponent2 = () => (
  ...
  {HeadingComponent()}
  {jsxHeading}
    <h1 id="heading"> functional component2</h1>
  </div>
);

baba.render(<HeadingComponent2 />);
...
// //   return (
// //     <div className="container">
// //       {title}     ---- > this title is a react element
// //       <Title />
// //       {Title()}
// //       <h1>Namaste React from Functional Component</h1>
// //     </div>
